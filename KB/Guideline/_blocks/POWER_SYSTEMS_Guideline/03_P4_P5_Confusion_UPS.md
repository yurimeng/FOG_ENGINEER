...
工程师动作：计算可支持的 IT 负载（PUE=1.15 → IT ≈ 1.74MW）；推荐 AC40×4 或 DC45×1 配置 ^mdc-24b079a2fe
...
- AC45 / DC45：UPS 及 UPS 电池**内置**于集装箱，提供分钟级瞬时切换后备，UL 合规 ^mdc-9dbd4f1d54
- AC40：UPS 及 UPS 电池**需客户外置自备**，AC40 本体不含 UPS ^mdc-35c0206afa

### UPS 型号标准

| IT Zone | UPS 型号 | 模块数 | 总功率 | UPS 放置 | UPS 电池后备时间 |
|---------|----------|--------|--------|---------|--------------|
| **AC40** | EATON 9395XR-600 | 4 UPM | 600kW | **外置（客户自备）** | ~10 分钟（客户自备 2×93LiG2） ^mdc-a127265324 |
| **AC45** | EATON 9395XR-600 | 4 UPM | 600kW | 内置（专用电力舱），UL 合规 | ~20 分钟（内置 2×93LiG2） ^mdc-ada3ef1320 |
| **DC45** | EATON 9395XR-1500 | 10 UPM | 1500kW | 内置，UL 合规 | ~8 分钟（内置 3×93LiG2） ^mdc-c010151c5b |
...
- **容量公式**：UPS 容量 ≥ IT Load ÷ PF × 1.2（AC45/DC45 已内置；AC40 需客户按此公式外置选型） ^mdc-19c3c7f800
- **型号标准化**：AC40/AC45 用 9395XR-600；DC45 用 9395XR-1500 ^mdc-b93c8c6ce7
