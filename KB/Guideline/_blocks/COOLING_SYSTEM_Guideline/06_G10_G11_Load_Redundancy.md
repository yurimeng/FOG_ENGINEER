...
|---------|-----------------|-----------------|
| **I50TS**（独立部署）| ~1.03–1.05 | ~1.08–1.12 ^mdc-012e313d6e |
| **I400C40** | `1.0x` | 逐站点用 <https://mdcx.org> 计算 ^mdc-39eb565736 |
| **I400C45** | `1.0x` | 逐站点用 <https://mdcx.org> 计算 ^mdc-c919cb5e98 |
| **DC45** | ~1.07–1.15 | ~1.25–1.35 ^mdc-a36f526dc3 |
