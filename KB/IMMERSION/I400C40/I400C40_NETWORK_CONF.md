...
- PDF 原件：[[I400C40_NETWORK_CONF.pdf|KB/3RD-PARTY/NETWORK/I400C40_NETWORK_CONF.pdf]]
- SVG 转换: [[I400C40_NETWORK_CONF_v1.svg]]
...
> v1.2 变更：从 `AC40_NETWORK_Guideline.md` 重命名为 `I400C40_NETWORK_CONF.md`，与所关联的 PDF 文件名对齐。本文件并非设计 Guideline（设计 Guideline 已统一归位至 `KB/Guideline/NETWORK_Guideline.md`），仅为产品级网络配置参考。
