...
| **Total Facility Load** | 随 PUE 变化，逐站点用 <https://mdcx.org> 计算| Depends on PUE |
...
| Support Response Level | **核心部件自 EXW 起一年 + 按年服务费；响应级别以 Invoice 为准** |
| Deployment Lead Time | **120 days EXW first batch / 90 days EXW for Scale; commercial, freight and installation not committed; dummy-load burn-in 5–30 days|
...
| **Total Lead Time** | **120 days EXW first batch / 90 days EXW for Scale; commercial, freight and installation not committed; dummy-load burn-in 5–30 days| From contract signing |
...
| Warranty | Core components, 1 year from EXW + annual service fee |
