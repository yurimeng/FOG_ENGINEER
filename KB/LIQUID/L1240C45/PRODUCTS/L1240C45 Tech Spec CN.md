...
| **整体电力负荷** | 随 PUE 变化，逐站点用 <https://mdcx.org> 计算| 取决于 PUE |
...
|------|------|
| 质保期 | **1 年** |
| 支持响应级别 | **核心部件自 EXW 起一年 + 按年服务费；响应级别以 Invoice 为准** |
| 部署周期 | **首批 120 天 EXW / Scale 90 天 EXW；商务·运输·安装不承诺；假负载运行期 5–30 天|
| 现场调试服务 | **包含在安装服务中** |
| 年度维护合同 | **待确认** |
