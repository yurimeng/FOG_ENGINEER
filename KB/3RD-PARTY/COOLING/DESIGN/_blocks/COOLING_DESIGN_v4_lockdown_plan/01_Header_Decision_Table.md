...
| 整体散热架构 | DC45 三支路重评估 2026-05-21（Rev 11）三支路 | — | 沿用三支路骨架 ^mdc-c0a2281a9a |
...
| 路径 | 当前版本 | v4 状态 |
|---|---|---|
| `KB/LIQUID/L1240C45/DESIGN/L1240C45_Thermal_Assessment_6Sites.md` | V2.0（2026-05-22）| **基线沿用**，§2.4 / §3.4 / §4.x / §8 各站点表中 FWS 26–28°C 需在 v4 重算 PUE 后联动改 ^mdc-3865a69db5 |
| `KB/LIQUID/L1240C45/DESIGN/L1240C45 三支路冷却重评估 2026-05-21.md` | Rev 11 | **架构骨架沿用**，§1.3 / §2.x / §3.x / §4.x 中 TCS 26–28°C 全部需联动改 ^mdc-debb8b88dd |
