...
**关键术语**：本文档所称 "CRAH"（Computer Room Air Handler）特指 DC45 顶部均匀排布的吊顶精密空调单元，物理实现为 STULZ OHS-084-DG-FC 自含式 DX。功能上承担机房残余空气热处理（≠ 传统 CRAH 全 CW 盘管型，自带压缩机）。
...
| **承载结构** | DC45 顶部钢梁，单台 250 kg × 9 = **2250 kg 顶置载荷** | ⚠️ 见 §11 Q5 |
