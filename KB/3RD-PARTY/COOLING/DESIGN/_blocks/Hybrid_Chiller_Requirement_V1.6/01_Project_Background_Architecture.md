...
- **Chiller 功能：** 为 CDU 一次侧（外部 TCS）提供稳定冷冻水供应，覆盖 CDU 全部三支路总散热（S-Max 1350 kW + 板换/管损/泵热 ≈ 1400 kW，含余量按 ≥ 1,600 kW 设计；S-Max 数值按 [[../../FOG D Series/DESIGN/DC45 三支路冷却重评估 V4|V4 锁定]] §4.4 / §6.2，对应 TCS 26°C 单点 + 4°C CDU 板换接近温差）
