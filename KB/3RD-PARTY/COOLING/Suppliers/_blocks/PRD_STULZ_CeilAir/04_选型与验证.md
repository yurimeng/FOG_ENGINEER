...
| IT Zone | 推荐型号 | 数量 | 备注 |
|---------|----------|------|------|
| **DC45**(DLC 三支路 Branch 3) | **OHS-084-DG-FC** | **9 套** (9 个 DLC 机柜顶置 1:1) | 标定 25.6 kW Total / 20.4 kW Sensible @ 80°F; FC 25.6 kW → 31.1 kW (EGT 45°F); 满足 DC45 残余热处理需求; 详见 [[../DESIGN/CRAH_Requirement v1.3#^crah-3-2-scenario-matrix]] |
