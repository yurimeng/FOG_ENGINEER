...
| [[PRD-STULZ-CRS560CW]] | STULZ CRS 560 CW 房间级 **CW** 精密空调 PRD(**L1800C45** CRAH 侧 10/16 °C; ✅ ATS approved 2026-08-30) |
...
| **房间级 CW 精密空调（待定）** | STULZ CW330 | STULZ | 归属 SKU ⏳ 待定(疑 L450C20 CRAH 侧); **全部规格参数未到** —— 等厂家选型书与外形图, 预期 **2026-08-31(周一)**; 参数到位前不得入 BOM 或方案 | [[PRD-STULZ-CW330]] | ⏳ **#unconfirmed** |
...
| **CRAC 规格** | CRAH 技术规格需求书 | — | 规范 CRAH 选型与设计要求 | [[CRAH_Requirement V5]] | (规范) |
...
> - **L1800C45(IT 1800kW · 双环路)**→ GPU 侧 STULZ SCR 14103 W(1200 kW/台) + CRAH 侧 STULZ CRS 560 CW(10/16 °C);**台数与冗余模型未锁定,见两份 PRD 的 Q1**
> - **L450C20(IT 450kW · 双环路)**→ ⏳ **冷却选型未定**。CRAH 疑为 CW330(等厂家参数 2026-08-31 + ATS 指定归属), CDU 未指定。见 [[PRD-STULZ-CW330]] Q1
