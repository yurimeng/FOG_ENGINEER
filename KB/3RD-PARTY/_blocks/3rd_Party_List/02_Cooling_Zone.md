...
| [[PRD-STULZ-CRS560CW]] | STULZ CRS 560 CW **CyberRow CW 列间冷冻水空调** PRD(**L1800C45** × 2 台, 与 CRS 330 CW × 6 混配; 净 54.7 kW/台 · 10/16 °C; ✅ ATS approved 2026-08-30) |
| [[PRD-STULZ-SCR14103W]] | STULZ SCR 14103 W **CDU** PRD(**L1800C45** GPU 侧 · 1200 kW · FWS 36/46 · TCS 40/50; ✅ ATS approved 2026-08-30) |
| [[PRD-STULZ-CW330]] | STULZ CRS 330 CW(CW330) **CyberRow CW 列间冷冻水空调** PRD(**L1800C45** × 6 + **L450C20** × 2(N+1); 站点记净 33 kW/台, 厂家选型书预期 2026-08-31) |
...
| **CyberRow CW 列间空调（小机型）** | STULZ CRS 330 CW(CW330) | STULZ | **L1800C45 × 6**(与 CRS 560 CW × 2 混配) + **L450C20 × 2**(N+1); 站点记净 33 kW/台(user-supplied, 非厂家选型书); **单台热工/水力/外形参数待厂家**, 预期 2026-08-31 | [[PRD-STULZ-CW330]] | ✅ 归属台数已定 / ⏳ 单台规格 |
| **CyberRow CW 列间空调（大机型）** | STULZ CRS 560 CW(非标版) | STULZ | **L1800C45 × 2**, 与 CRS 330 CW × 6 混配共 8 台; 净 54.7 kW/台(毛 57.3), 11,200 m³/h, 冷冻水 10/16 °C, 400V/50Hz; 左/右侧向送风列间机; 台数/冗余(Q1) · 认证(Q4) 为 P0 | [[PRD-STULZ-CRS560CW]] | ✅ **ATS approved** (2026-08-30) |
...
> - **L1800C45(IT 1800kW · 双环路)**→ GPU 侧 **2× STULZ SCR 14103 W**;列间侧 **2× CRS 560 CW + 6× CRS 330 CW**(混配共 8 台, 净冷量 307.4 kW, 10/16 °C)。**冗余归属未锁定,见两份 PRD 的 Q1**
> - **L450C20(IT 450kW · 双环路)**→ GPU 侧 **1× STULZ SCR 14103 W**;列间侧 **2× CRS 330 CW**(N+1, 单台承载全负荷)。⏳ CRS 330 CW 单台规格待厂家, 预期 2026-08-31。见 [[PRD-STULZ-CW330]]
...
| STULZ | CyberRow CW 列间空调(CRS 560 CW / CRS 330 CW) · CDU(SCR 14103 W) | ✅ **ATS approved** (2026-08-30) —— L1800C45 / L450C20 冷却选型 |
| STULZ | 吊顶 DX 空调(OHS-084) | ⏳ 正在 review —— **CE / 50Hz 缺席**, 仅 L1240C45 |
