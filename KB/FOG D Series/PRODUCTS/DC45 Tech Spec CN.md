...
> **受众说明：** 本文档为销售 / 售前交付物,目标读者:客户、客户经理、方案架构师。参数为准绳值;如与工程设计冲突,以 [[../DESIGN/STD_DC45|STD_DC45]] 统一参数表为准。参数基准:V1.4 (2026-05-21)。
>
> **English version:** [[DC45 Tech Spec EN]]

版本：V1.4 | 日期：2026-05-21

> **V1.4 更新（基于 [[../DESIGN/DC45 三支路冷却重评估 V4|DC45 三支路冷却重评估 V4]]）：**
