---
title: "L1240C45 Section 14: Key Specifications Summary"
...
| Warranty | Core components, one year from EXW; annual service fee thereafter. Response level (ONSITE / NBD / 9×5 / 24×7) is governed by the Invoice |
| Lead time | 120 days EXW first batch; 90 days EXW for Scale; dummy-load burn-in 5–30 days (not covered by the EXW commitment) |
| PUE | `1.0x` — computed per site at <https://mdcx.org> |
