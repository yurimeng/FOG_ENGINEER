...
L1240C45 是 **45ft 集装箱规格的直冷液冷（DLC）模块化数据中心**，采用冷板式液冷技术（Direct Liquid Cooling），适用于超大算力 AI 集群高密度部署。

![[PDC_SLD_EN_light.svg|SuOCbROt9ozRtAxyvDrcBiXnnqc.png]]

> **冷却架构**：L1240C45 采用 **TCS PG25 三支路并联** 冷却架构，所有热量统一通过 TCS 二次环路送至室外侧（混合干冷器 + DX）：
