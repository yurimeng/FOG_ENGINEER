...
| Item | Notes |
|------|-------|
| UPS placement | **External (customer-supplied)** — not inside I400C40 |
| Standard UPS | EATON **9395XR-600** (4×150kW = 600kW), heat ~**7.9kW** |
| UPS batteries | Customer **2×93LiG2** (332kW each), ~**10 min** |
| BESS path | Grid → BESS → I400C40 (Power Zone; **BESS ≠ UPS battery**) |
...
|---------|-----|-----------|---------|
| **I400C40** | 9395XR-600 | **External** | ~10 min (2×93LiG2) |
| I400C45 | 9395XR-600 | Internal power bay | ~20 min |
| L1240C45 | 9395XR-1500 | Internal | ~8 min (3×93LiG2) |
...
| Tank CDU | **1+1 / 2N** |
| I400C40 IT Zone container | **No internal N+1/2N** |
