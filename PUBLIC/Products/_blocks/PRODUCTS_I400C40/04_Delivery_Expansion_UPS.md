...
| 方向 | 说明 |
|------|------|
| MDC 混合 | 可与 DC45 混合构建 MDC ^mdc-f1da7feac0 |
| 横向扩展 | 增加 AC40 数量 ^mdc-6271f91b99 |
...
| -------- | ----------------- | ------ | ----- | -------- | ------- | --------------- | --------------------- |
| **AC40** | EATON 9395XR-600  | 4 UPM  | 150kW | 600kW    | ~7.9kW  | **外置（客户自备）**    | ~10 分钟（客户自备 2×93LiG2） ^mdc-3a5cd4a9aa |
| **AC45** | EATON 9395XR-600  | 4 UPM  | 150kW | 600kW    | ~7.9kW  | 内置（专用电力舱），UL 合规 | ~20 分钟（内置 2×93LiG2） ^mdc-ad5944c84c |
| **DC45** | EATON 9395XR-1500 | 10 UPM | 150kW | 1500kW   | ~46.9kW | 内置，UL 合规        | ~8 分钟（内置 3×93LiG2） ^mdc-6204928f14 |
