...
> ⚠️ **UPS 电池 vs BESS 电池：** "UPS 电池后备"指 UPS 配套的 93LiG2 磷酸铁锂电池柜（**分钟级**瞬时切换后备）。BESS（如 Tesla Megapack / 国轩）是独立大型储能系统（**小时级**供电），两者完全不同。参见 [[I400C45#8. AC45 vs AC40 vs DC45 对比|第 8 节对比表]]。
